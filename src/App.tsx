...
const VendorModal = ({ vendor, onClose, lang }: { vendor: Vendor, onClose: () => void, lang: 'en' | 'zh' }) => (
  <motion.div 
    ...
    animate={{ opacity: 1 }}
    exit={{ opacity: 0 }}
    className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-brand-ink/80 backdrop-blur-[2px]"
    onClick={onClose}
  >
    <motion.div 
    ...
    >
      <button onClick={onClose} className="absolute top-6 right-6 z-10 hover:text-brand-accent transition-colors bg-brand-cream/50 p-2 rounded-full backdrop-blur-[2px]">
        <X size={20} />
      </button>
...
const Navbar = ({ lang, setLang }: { lang: 'en' | 'zh', setLang: (l: 'en' | 'zh') => void }) => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 border-b border-white/10 ${scrolled ? 'bg-brand-ink/90 backdrop-blur-[2px] py-4' : 'bg-transparent py-8'}`}>
...
const Hero = ({ lang }: { lang: 'en' | 'zh' }) => {
  return (
    <section className="relative min-h-screen grid grid-cols-12 border-b border-white/10">
      ...
      <div className="col-span-12 lg:col-span-5 p-12 border-r border-white/10 flex flex-col justify-center pt-32 bg-brand-ink/75 md:bg-brand-ink/85 backdrop-blur-[2px] text-brand-cream">
        <motion.div
      ...
      <div className="col-span-12 lg:col-span-7 relative overflow-hidden pt-32 lg:pt-0 backdrop-blur-[2px] bg-brand-ink/40 md:bg-brand-ink/60">
...
export default function App() {
  ...
  return (
    <div className="relative text-brand-ink min-h-screen flex flex-col box-border overflow-x-hidden">
      ...
      {/* About Section */}
      <section id="about" className="grid grid-cols-12 backdrop-blur-[2px] bg-brand-cream/75 md:bg-brand-cream/90 relative z-10 -mt-px">
      ...
      {/* Schedule Section */}
      <section id="schedule" className="py-32 bg-brand-ink/95 text-brand-cream overflow-hidden backdrop-blur-[2px]">
      ...
      {/* Experience Section */}
      <section id="vendors" className="backdrop-blur-[2px] text-brand-ink relative z-10 -mt-px">
        ...
        <div className="p-12 md:p-24 flex flex-col backdrop-blur-[2px] bg-brand-cream/75 md:bg-brand-cream/85">
          <div className="container mx-auto">
      ...
      {/* Sponsors Section */}
      <section id="sponsors" className="py-32 bg-white/75 md:bg-white/80 backdrop-blur-[2px] relative z-10 -mt-px">
        <div className="container mx-auto px-6">
      ...
      {/* Location Section */}
      <section id="location" className="py-32 bg-brand-cream/75 md:bg-brand-cream/90 backdrop-blur-[2px] relative z-10 -mt-px">
        <div className="container mx-auto px-6">
      ...
      {/* Footer */}
      <footer className="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 bg-brand-ink/95 text-brand-cream py-10 md:h-24 md:py-0 backdrop-blur-[2px]">
