...
const Hero = ({ lang }: { lang: 'en' | 'zh' }) => {
  return (
    <section className="relative min-h-screen grid grid-cols-12 border-b border-white/10">
      ...
      <div className="col-span-12 lg:col-span-5 p-12 border-r border-white/10 flex flex-col justify-center pt-32 bg-brand-ink/80 backdrop-blur-md text-brand-cream">
        <motion.div
...
export default function App() {
  ...
  return (
    <div className="relative text-brand-ink min-h-screen flex flex-col editorial-thick-border box-border overflow-x-hidden">
      ...
      {/* About Section */}
      <section id="about" className="grid grid-cols-12 backdrop-blur-sm bg-brand-cream/85 relative z-10 -mt-px">
      ...
      <section id="vendors" className="backdrop-blur-sm text-brand-ink relative z-10 -mt-px">
        ...
        <div className="p-12 md:p-24 flex flex-col bg-brand-cream/85">
          <div className="container mx-auto">
      ...
      {/* Sponsors Section */}
      <section id="sponsors" className="py-32 bg-white/75 backdrop-blur-sm relative z-10 -mt-px">
        <div className="container mx-auto px-6">
      ...
      {/* Location Section */}
      <section id="location" className="py-32 bg-brand-cream/85 backdrop-blur-sm relative z-10 -mt-px">
        <div className="container mx-auto px-6">
